# @mono-hono-electron-react/desktop

This package contains the Electron desktop app for the `mono-hono-electron-react` workspace.
...
### `pnpm --filter @mono-hono-electron-react/desktop dev:renderer`

Runs only the renderer dev server.

### `pnpm --filter @mono-hono-electron-react/desktop build`
